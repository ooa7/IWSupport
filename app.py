...
loader = CSVLoader(file_path='aiproject.csv')
...
# question = "how do you add a new bank to the list of banks?"
...
template = """
You are a world class Nigerian historian and economist as well as a trusted InfoWARE guide. 
...
def main():
    st.set_page_config(
        page_title="IWSupport ChatBot", page_icon="🤖")
    st.header("InfoWARE Support ChatBot ")
